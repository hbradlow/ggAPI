...
class Starcraft2Scraper(Scraper):
	...
	def getData(self): 
		return {"Starcraft" : {"Username" : self.username, "Score" : self.score, "Decals" : self.decals, "League Wins" : self.league_wins, "Games Won" : self.games, "Recent Achievements" : self.recent_achievements}}
